...
$("#form-asset").validate({
  submitHandler: function(form) {
    ...
    $.ajax({
      url:  $('meta[name=site-url]').attr("content")+'sport_assets/store?scope='+$('meta[name=scope]').attr("content")+'&id='+$('meta[name=params]').attr("content"),
      data: formData,
      type: "POST",
      contentType: false,
      beforeSend: function() {
...
$("#form-image").validate({
  submitHandler: function(form) {
    $.ajax({
      url:  $('meta[name=site-url]').attr("content")+'sport_assets/store?scope='+scope+'&params='+$('meta[name=params]').attr("content")+'&id='+value,
