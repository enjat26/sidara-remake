...
class ChampionshipModel extends Model
{
   ...
   */
  protected $table              = 'sport_championships';
  protected $primaryKey         = 'sport_championship_id';
  ...
  protected $allowedSearch      = [
                                    ...
                                    'sport_championship_level',
                                    'sport_championship_category',
                                  ];
...
/**
 * -----------------------------------------------------------------------
 * Filename: ChampionshipModel.php
 * Location: ./app/Modelss/Sport/Championship/ChampionshipModel.php
 * -----------------------------------------------------------------------
 */
