...
class ClubModel extends Model
{
   ...
   */
  protected $table              = 'sport_clubs';
  protected $primaryKey         = 'sport_club_id';
  ...
  public function fetchData(array $where = NULL, bool $limit = false, string $order = 'DESC')
  {
    $query = $this->table($this->table)
                  ...
                  ->join('districts', 'districts.district_id = ' . $this->table . '.sport_club_district_id')
...
/**
 * -----------------------------------------------------------------------
 * Filename: Club\Youth\ClubModel.php
 * Location: ./app/Modelss/Club/Youth/ClubModel.php
 * -----------------------------------------------------------------------
 */
