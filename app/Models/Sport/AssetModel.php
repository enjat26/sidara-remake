...
class AssetModel extends Model
{
  ...
  public function fetchData(array $where = NULL, bool $limit = false, string $order = 'DESC')
  {
    $query = $this->table($this->table)
      ...
      ->join('sport_asset_categorys', 'sport_asset_categorys.asset_category_id = ' . $this->table . '.asset_category_id')
 ...
 * Location: ./app/Models/Sport/AssetModel.php
 * -----------------------------------------------------------------------
 */
