...
class CaborModel extends Model
{
   ...
   */
  protected $table              = 'sport_cabors';
  protected $primaryKey         = 'sport_cabor_id';
  ...
  public function fetchData(array $where = NULL, bool $limit = false, string $order = 'DESC')
  {
    $query = $this->table($this->table)
                  ...
                  ->join('districts', 'districts.district_id = ' . $this->table . '.sport_cabor_district_id')
 ...
 * Location: ./app/Modelss/Sport/OrganizationModel.php
 * -----------------------------------------------------------------------
 */
