...
class EntrepreneurshipModel extends Model
{
  /**
   ...
   */
  protected $table              = 'youth_entrepreneurships';
  ...
  protected $allowedSearch      = [
                                    'year',
                                    'entrepreneurship_business_name',
                                    'entrepreneurship_business_type',
                                    'entrepreneurship_ownership',
                                    'district_type',
                                    'district_name',
                                  ];
...
/**
 * -----------------------------------------------------------------------
 * Filename: EntrepreneurshipModel.php
 * Location: ./app/Models/Youth/EntrepreneurshipModel.php
 * -----------------------------------------------------------------------
 */
