...
class ScoutModel extends Model
{
  ...
  protected $allowedSearch      = [
                                    'year',
                                    'scout_participant_name',
                                    'scout_championship_name',
                                    'scout_championship_level',
                                    'scout_championship_organizer',
                                    'scout_championship_result',
                                    'district_type',
                                    'district_name',
                                  ];
...
/**
 * -----------------------------------------------------------------------
 * Filename: ScoutModel.php
 * Location: ./app/Models/Youth/ScoutModel.php
 * -----------------------------------------------------------------------
 */
