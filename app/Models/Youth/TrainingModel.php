...
class TrainingModel extends Model
{
   ...
   */
  protected $table              = 'youth_trainings';
  protected $primaryKey         = 'youth_training_id';
  ...
  protected $allowedSearch      = [
                                    'youth_training_name',
                                    'youth_training_year',
                                    'youth_training_explanation',
                                    'district_name',
                                  ];

  protected $columnSearch        = [
                                     'year'       => ['youth_training_year'],
                                   ];
  ...
  public function fetchData(array $where = NULL, bool $limit = false, string $order = 'DESC')
  {
    $query = $this->table($this->table)
                  ...
                  ->join('districts', 'districts.district_id = '.$this->table.'.youth_training_district_id')
...
/**
 * -----------------------------------------------------------------------
 * Filename: TrainingModel.php
 * Location: ./app/Models/Youth/TrainingModel.php
 * -----------------------------------------------------------------------
 */
