...
class NavigationModel extends Model
{
  ...
  public function fetchData(array $where = NULL, bool $limit = false, string $order = 'DESC')
  {
    $query = $this->table($this->table)
                  ...
                  ->join('menu_group', 'menu_group.group_id = '.$this->table.'.group_id')
                  ->orderBy('menu_group.group_id')
                  ->orderBy('menu_page.menu_order');
...
/**
 * -----------------------------------------------------------------------
 * Filename: eventModel.php
 * Location: ./app/Modelss/eventModel.php
 * -----------------------------------------------------------------------
 */
