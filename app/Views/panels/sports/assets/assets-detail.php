...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Kelola <?= $data['assetData']->asset_type; ?> pada <?= $data['arguments'] == 'sports' ? 'Bidang Kepemudaan' : 'Bidang Olahraga'; ?></h4>
...
<div class="row justify-content-center">
    <div class="col-md-6 col-xl-3">
        ...
        <?php if ($libIonix->builderQuery('sport_asset_images')->where(['asset_id' => $data['assetData']->asset_id])->countAllResults() == false) : ?>
            <div class="row justify-content-center">
            ...
            <!-- end row -->
        <?php else : ?>
            <?php foreach ($libIonix->builderQuery('sport_asset_images')->where(['asset_id' => $data['assetData']->asset_id])->get()->getResult() as $row) : ?>
                <div class="card mb-2">
                    <div class="card-body">
    ...
    <div class="col-md-6 col-xl-9">
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-title-desc">Kelola informasi terhadap <strong><?= $data['assetData']->asset_type; ?> <?= $data['arguments'] == 'sports' ? 'Pemuda' : 'Olahraga'; ?></strong> ini.</p>
                        ...
                        <div class="p-2">
                            <div class="my-4">
                                ...
                                <p class="card-description text-center">
                                    Sesuaikan informasi lengkap terhadap <strong><?= $data['assetData']->asset_type; ?> <?= $data['arguments'] == 'sports' ? 'Pemuda' : 'Olahraga'; ?></strong> ini.
...
<?= script_tag($configIonix->assetsFolder['local'] . 'js/panel/sports/assets/asset-detail.init.js'); ?>
