        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <?php if ($libIonix->builderQuery('youth_asset_categorys')->countAllResults() == false) : ?>
                        <!-- start row -->
                    ...
                    <?php else : ?>
                        <div class="category-list p-2" data-simplebar>
                            <?php $i = 1; ?>
                            <?php foreach ($libIonix->builderQuery('youth_asset_categorys')->orderBy('asset_category_id', 'DESC')->get()->getResult() as $row) : ?>
...
<?= $this->section('javascript'); ?>
    ...
    <?= script_tag($configIonix->assetsFolder['local'] . 'js/panel/youths/assets/assets.init.js'); ?>
<?= $this->endSection(); ?>
