...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-sm-flex align-items-center justify-content-between">
            <h4 class="mb-sm-0 font-size-18">Organisasi Pemuda</h4>
        ...
        <div class="card">
            <div class="card-body">
                <div class="row align-items-center">
                    <div class="col-lg-5">
                        <h4 class="card-title">Data Organisasi Pemuda</h4>
                        <p class="card-title-desc text-justify">
                            Kelola setiap Data <strong>Organisasi Pemuda</strong> yang ada di <strong>Provinsi Banten</strong> pada Halaman ini.
                            Informasi <strong>Organisasi Pemuda</strong> sangat berguna agar <strong>Publik</strong> dapat mendukung atau bahkan bergabung dengan <strong>Organisasi</strong> tersebut.
                        ...
                        <div class="button-items mb-4">
                            ...
                            <button type="button" class="btn btn-light waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal-organization" data-scope="<?= $libIonix->Encode('organization'); ?>" key="add-organization"><i class="mdi mdi-plus me-1"></i> Tambah organisasi pemuda baru</button>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6 ms-auto">
                        <div class="card border border-success">
                            <div class="card-header bg-transparent border-success">
                                ...
                                <p class="card-text">Anda dapat memfilter data <strong>Organisasi Pemuda</strong> berdasarkan</p>
                            </div>
                            <div class="card-body">
...
<?= script_tag($configIonix->assetsFolder['local'] . 'js/panel/youths/organizations.init.js'); ?>
<?= $this->endSection(); ?>