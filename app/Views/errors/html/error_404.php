...
<head>
	...
	<title><?= strtoupper(config('ionix')->appCode);?> <?= ucwords(config('ionix')->appType);?> - Halaman tidak ditemukan</title>
			...
			<div class="container">
					<div class="row justify-content-center">
							<div class="col-lg-12">
									<div class="text-center mb-5">
											<h1 class="display-2 fw-medium">4<i class="mdi mdi-lifebuoy mdi-spin text-primary display-2"></i>4</h1>
											...
											<div class="row justify-content-center">
												<div class="col-lg-7">
													<p>Maaf! Sepertinya tidak dapat menemukan halaman yang Anda cari. Halaman yang Anda cari mungkin telah dihapus dengan namanya diubah atau untuk sementara tidak tersedia.</p>
												</div>
											</div>

											<div class="mt-3 text-center">
													<a class="btn btn-primary waves-effect waves-light" href="javascript:void(0);" onclick="history.back();">Kembali ke halaman sebelumnya</a>
											</div>
									</div>
							</div>
					</div>
					<div class="row justify-content-center">
							<div class="col-md-8 col-xl-6">
									<div>
											<img src="<?= config('ionix')->mediaFolder['image'];?>content/404.png" alt="" class="img-fluid">
									</div>
							</div>
					</div>
			</div>
